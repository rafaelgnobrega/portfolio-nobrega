  ...
  return (
    <div className={style.containerprojetos} id='projetos'>
        <Carousel activeIndex={index} onSelect={handleSelect} className={style.carrossel}>
          {/* ONEVENT */}
          <Carousel.Item className={style.itemCarrossel}>
            <Image
            ...
            <Carousel.Caption className={style.espaco}>
              ...
              <p className={style.descricao}>O Onevent é um projeto pessoal de aplicativo mobile, sua interface <br/>foi desenvolvida no FIGMA. <a className={style.link} href="https://www.linkedin.com/feed/update/urn:li:activity:6950876294901293056/" rel="opener">Visualizar pelo LinkedIn\&gt;</a></p>
            </Carousel.Caption>
          </Carousel.Item>
          {/* BLUEBIRD */}
          <Carousel.Item>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption className={style.espaco}>
              ...
              <p className={style.descricao}>
                Um dos meus primeiros projetos de desenvolvimento web,<br/> utilizando apenas HTML e CSS. <a className={style.link} href="https://rafaelgnobrega.github.io/tela-de-cadastro/" rel="opener">Visitar site\&gt;</a>
              </p>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
